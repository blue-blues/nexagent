                ...
                if action == "stealth_mode":
                    ...
                    if extraction_type == "table":
                        try:
                            ...
                            if data:
                                ...
                                return ToolResult(error=f"No tables found with selector: {selector}")
                        ...
                        try:
                            ...
                            if data:
                                ...
                                return ToolResult(error=f"No lists found with selector: {selector}")
                        except Exception as e:
                        ...
                        try:
                            ...
                            if data:
                                ...
                                return ToolResult(error=f"No elements found with selector: {selector}")
                        except Exception as e:
                    ...
                    try:
                        ...
                        if extract_type == "text":
                            ...
                            # Default to extracting everything (same as "all")
                            result = {}
                            result["text"] = await self._extract_page_text(context)
                            result["links"] = await self._extract_page_links(context)
                            result["tables"] = await self._extract_all_tables(context)
    ...
    async def _extract_page_text(self, context: BrowserContext) -> str:
        ...
        try:
            ...
            if not text or len(text.strip()) < 50:
                text = await context.execute_javascript(
                    """Array.from(document.querySelectorAll('p, h1, h2, h3, h4, h5, h6, li, td, th, a, span, div'))
