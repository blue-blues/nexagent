...
class Session(BaseModel):
    ...
    def add_task(self, prompt: str, result: str, success: bool, timeline_data: Optional[Dict[str, Any]] = None, **kwargs) -> None:
        ...
        Args:
            ...
            timeline_data: Optional timeline data associated with the task
        ...
        # Add timeline data if provided
        if timeline_data:
            task_entry["timeline"] = timeline_data

        # Add metadata if provided
        if 'metadata' in kwargs and isinstance(kwargs['metadata'], dict):
            task_entry["metadata"] = kwargs['metadata']
