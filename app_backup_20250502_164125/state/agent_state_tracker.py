...
class AgentStateTracker:
    ...
    def track_file_attachment(self, agent_id: str, file_path: str, file_name: str,
                             metadata: Optional[Dict[str, Any]] = None) -> str:
        """
        Track a file attachment action.

        Args:
            agent_id: ID of the agent processing the file
        ...
        Returns:
            ID of the tracked action
        """
        description = f"Processing file attachment: {file_name}"
        ...
        return self.track_action(
            agent_id=agent_id,
            action_type=ActionType.FILE_ATTACHMENT,
            description=description,
    ...
    def export_to_json(self) -> str:
        ...
        export_data = {
            ...
            "actions": {action_id: action.model_dump() for action_id, action in self.actions.items()},
